    ...
    public function showLKH($lkhno)
    {
        try {
            ...
            if ($isBsmActivity) {
                ...
                return view('transaction.rencanakerjaharian.lkh-report-bsm', [
            ...
            if ($isPanenActivity) {
                ...
                return view('transaction.rencanakerjaharian.lkh-report-panen', [
            ...
            return view('transaction.rencanakerjaharian.lkh-report', [
        ...
        if ($request->ajax() || $request->wantsJson()) {
            if ($success) {
                return response()->json([
                    ...
                    'rkhno' => $rkhno,
                    'redirect_url' => route('transaction.rencanakerjaharian.index')
                ]);
            } else {
                return response()->json([
                    'success' => false,
