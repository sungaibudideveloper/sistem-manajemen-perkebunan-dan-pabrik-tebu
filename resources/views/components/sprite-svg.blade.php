{{-- resources/views/components/sprite-svg.blade.php --}}
{{-- 
    SVG Sprite Icons - Single Source of Truth
    Usage: <svg><use href="#icon-name"></use></svg>
    
    Naming Convention: icon-{name}
    All icons use stroke, viewBox="0 0 24 24"
--}}
<svg xmlns="http://www.w3.org/2000/svg" class="hidden">
    ...
    <symbol id="icon-announcement" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M3 11l18-5v12L3 13v-2z"/>
        <path d="M11.6 16.8a3 3 0 11-5.8-1.6"/>
    </symbol>
    ...
    <symbol id="icon-dots-horizontal" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="12" cy="12" r="1"/>
        <circle cx="19" cy="12" r="1"/>
        <circle cx="5" cy="12" r="1"/>
    </symbol>

    <symbol id="icon-dots-vertical" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="12" cy="12" r="1"/>
