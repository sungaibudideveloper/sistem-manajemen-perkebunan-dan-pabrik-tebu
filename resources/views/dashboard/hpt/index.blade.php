                            ...
                            <div class="relative">
                                <div class="dropdown relative">
                                    <button type="button" id="dropdownButtonAvg"
                                        class="w-[220px] flex items-center justify-between rounded-md font-medium border border-gray-300 shadow-sm hover:bg-gray-50 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 bg-white px-4 py-2 text-sm text-gray-700">
                                        ...
                                        <div class="flex flex-col space-y-1 min-w-max">
                                            ...
                                            <label class="inline-flex items-center" onchange="this.form.submit()">
                                                <input type="checkbox" id="selectAllBlok"
                                                    class="form-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                                    {{ old('blok', request()->blok ?? []) && count(old('blok', request()->blok ?? [])) === count($kdBlokHPTOpt) ? 'checked' : '' }} />
                                                <span class="ml-2">(Select All)</span>
                                            </label>
                                        ...
                                        <div class="flex flex-col space-y-1 min-w-max">
                                            ...
                                            <label class="inline-flex items-center" onchange="this.form.submit()">
                                                <input type="checkbox" id="selectAllPlot"
                                                    class="form-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                                    {{ old('plot', request()->plot ?? []) && count(old('plot', request()->plot ?? [])) === count($kdPlotHPTOpt) ? 'checked' : '' }} />
                                                <span class="ml-2">(Select All)</span>
                                            </label>
                        ...
                        callbacks: {
                            label: function(context) {
                                ...
                                const formattedValue =
                                    verticalLabel === '% PPT' || verticalLabel === '% PBT' || verticalLabel ===
                                    '% PPT Aktif' || verticalLabel === '% PBT Aktif' || verticalLabel ===
