<x-layout>
                ...
                <form id="filterFormHPT">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <h3 class="text-base font-bold text-white">Filter Data HPT</h3>
                        </div>
                    </div>
                    ...
                    <div class="px-4 py-4 bg-gray-50 flex items-center gap-3 justify-start flex-wrap rounded-b-xl">
                        ...
                        <div class="filter-item-compact">
                            ...
                            <div class="relative">
                                <button type="button" id="dropdownButtonAvgHPT"
                                    ...
                                    <span id="dropdownLabelAvgHPT" class="truncate">% PPT</span>
                                    ...
                                    <div class="flex flex-col space-y-0.5">
                                        @foreach ($verticalLabels as $key => $label)
                                            <button type="button"
                                                ...
                                                onclick="selectAverageHPT('{{ $key }}', '{{ $label }}')">{{ $label }}</button>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="vertical" id="selectedAverageHPT" value="per_ppt">
                        </div>
                        ...
                        <div class="filter-item">
                            ...
                            <div class="relative">
                                <button type="button" id="dropdownButtonCompHPT"
                                ...
                                <div id="dropdownContentCompHPT"
                                    ...
                                    <div class="flex flex-col space-y-2">
                                        ...
                                        <div class="relative">
                                            <input type="text" id="searchCompHPT" placeholder="Search..."
                                        ...
                                        <div class="max-h-[250px] overflow-auto">
                                            <label
                                                ...
                                                <input type="checkbox" id="selectAllCompHPT"
                                            ...
                                            @foreach ($kdCompHPTOpt as $comp)
                                                <label
                                                    class="inline-flex items-center hover:bg-emerald-50 p-2 rounded-md cursor-pointer comp-item-hpt"
                                                    data-comp-name="{{ strtolower($comp->name) }}">
                                                    <input type="checkbox" name="companycode[]"
                                                        value="{{ $comp->companycode }}"
                                                        class="form-checkbox comp-checkbox-hpt w-4 h-4 text-emerald-600 rounded focus:ring-emerald-500" />
                        ...
                        <div class="filter-item">
                            ...
                            <div class="relative">
                                <button type="button" id="dropdownButtonBlokHPT"
                                    class="flex items-center justify-between rounded-lg border border-gray-300 shadow-sm hover:border-emerald-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 bg-white px-3 py-2 text-sm font-medium text-gray-800 transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5 text-emerald-500"
                                        viewBox="0 0 20 20" fill="currentColor">
                                        <path
                                ...
                                <div id="dropdownContentBlokHPT"
                                    ...
                                    <div class="flex flex-col space-y-2">
                                        ...
                                        <div class="relative">
                                            <input type="text" id="searchBlokHPT" placeholder="Search..."
                                                class="w-full pl-8 pr-3 py-1.5 border border-gray-300 rounded-md focus:border-emerald-400 focus:ring-1 focus:ring-emerald-200 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-4 w-4 absolute left-2.5 top-2 text-gray-400" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div class="max-h-[250px] overflow-auto">
                                            <label
                                                ...
                                                <input type="checkbox" id="selectAllBlokHPT"
                                                    class="form-checkbox w-4 h-4 text-emerald-600 rounded focus:ring-emerald-500" />
                                            ...
                                            @foreach ($kdBlokHPTOpt as $blok)
                                                <label
                                                    class="flex items-center hover:bg-emerald-50 p-2 rounded-md cursor-pointer blok-item-hpt w-full"
                                                    data-blok-name="{{ strtolower($blok->blok) }}">
                                                    <input type="checkbox" name="blok[]"
                                                        value="{{ $blok->blok }}"
                                                        class="form-checkbox blok-checkbox-hpt w-4 h-4 text-emerald-600 rounded focus:ring-emerald-500" />
                                                    <span
                        ...
                        <div class="filter-item">
                            ...
                            <div class="relative">
                                <button type="button" id="dropdownButtonPlotHPT"
                                    class="flex items-center justify-between rounded-lg border border-gray-300 shadow-sm hover:border-emerald-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 bg-white px-3 py-2 text-sm font-medium text-gray-800 transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5 text-emerald-500"
                                        viewBox="0 0 20 20" fill="currentColor">
                                        <path
                                ...
                                <div id="dropdownContentPlotHPT"
                                    class="z-50 absolute hidden mt-1 w-[170px] text-sm bg-white border border-gray-200 shadow-xl rounded-lg p-3 max-h-[380px]">
                                    <div class="flex flex-col space-y-2">
                                        <h6 class="text-xs font-bold text-gray-900 border-b pb-2">Pilih Plot</h6>
                                        <div class="relative">
                                            <input type="text" id="searchPlotHPT" placeholder="Search..."
                                                class="w-full pl-8 pr-3 py-1.5 border border-gray-300 rounded-md focus:border-emerald-400 focus:ring-1 focus:ring-emerald-200 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-4 w-4 absolute left-2.5 top-2 text-gray-400" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div class="max-h-[250px] overflow-auto">
                                            <label
                                                class="inline-flex items-center hover:bg-emerald-50 p-2 rounded-md cursor-pointer border-b border-gray-100">
                                                <input type="checkbox" id="selectAllPlotHPT"
                                                    class="form-checkbox w-4 h-4 text-emerald-600 rounded focus:ring-emerald-500" />
                                                <span class="ml-2 font-semibold text-emerald-700 text-sm">(Select
                                                    All)</span>
                                            </label>
                                            @foreach ($kdPlotHPTOpt as $plot)
                                                <label
                                                    class="flex items-center hover:bg-emerald-50 p-2 rounded-md cursor-pointer plot-item-hpt w-full"
                                                    data-plot-name="{{ strtolower($plot->plot) }}">
                                                    <input type="checkbox" name="plot[]"
                                                        value="{{ $plot->plot }}"
                                                        class="form-checkbox plot-checkbox-hpt w-4 h-4 text-emerald-600 rounded focus:ring-emerald-500" />
                                                    <span
                        ...
                        <div class="filter-item">
                            ...
                            <div class="relative">
                                <button type="button"
                                    ...
                                    id="menu-button-hpt" onclick="toggleDropdownHPT()">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5 text-emerald-500"
                                        viewbox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                                ...
                                <div class="absolute z-50 mt-1 w-[250px] rounded-lg bg-white border border-gray-200 shadow-xl hidden"
                                    id="menu-dropdown-hpt">
                                    <div class="py-3 px-3">
                                        <div class="flex items-center gap-2 mb-2">
                                            <div class="flex-1">
                                                <label for="start_month_hpt"
                                                    class="block text-xs font-semibold text-gray-700 mb-1">Start</label>
                                                <select id="start_month_hpt" name="start_month"
                                            ...
                                            <div class="w-20">
                                                <label for="start_year_hpt"
                                                    class="block text-xs font-semibold text-gray-700 mb-1">Year</label>
                                                <input type="text" name="start_year" id="start_year_hpt"
                                        ...
                                        <div class="flex items-center gap-2 mb-3">
                                            ...
                                            <span class="text-gray-400 mt-5">/</span>
                                            <div class="w-20">
                                                <label for="end_year_hpt"
                                                    class="block text-xs font-semibold text-gray-700 mb-1">Year</label>
                                                <input type="text" name="end_year" id="end_year_hpt"
                                                    oninput="validateNumber(this)"
                                                    class="border rounded-md border-gray-300 p-1.5 w-full text-xs focus:border-emerald-400 focus:ring-1 focus:ring-emerald-200"
                                                    maxlength="4" value="{{ now()->format('Y') }}">
                                            </div>
                                        </div>
                                        <button type="button" onclick="applyFiltersHPT()"
                        ...
                        <div class="filter-item">
                            ...
                            <div class="relative">
                                <button type="button"
                                    class="inline-flex items-center rounded-lg border border-gray-300 shadow-sm px-3 py-2 bg-white text-sm font-medium text-gray-800 hover:border-emerald-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all"
                                    id="age-menu-button-hpt" onclick="toggleAgeDropdownHPT()">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5 text-emerald-500"
                                        viewbox="0 0 20 20" fill="currentColor">
                                        <path
            ...
            <div class="w-full">
                <div class="bg-white shadow-lg rounded-xl p-5 border border-gray-200">
                    ...
                    <div class="relative min-h-[400px]">
                        ...
                        <div id="emptyStateHPT" class="flex flex-col items-center justify-center py-20">
                        ...
                        <!-- Chart Canvas -->
                        <canvas id="pivotChartHPT" class="hidden"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        let myChartHPT = null;
        let currentVerticalLabelHPT = '% PPT';
        let currentHorizontalLabelHPT = '';
        let hasDataHPT = false; // Track if chart has data

        function initChartHPT(data) {
            const ctx = document.getElementById('pivotChartHPT').getContext('2d');
            if (myChartHPT) myChartHPT.destroy();
            ...
            currentVerticalLabelHPT = data.verticalLabel || currentVerticalLabelHPT;
            currentHorizontalLabelHPT = data.horizontalLabel || currentHorizontalLabelHPT;

            const percentageFields = ['% PPT', '% PBT', '% PPT Aktif', '% PBT Aktif', '% Intensitas Kerusakan'];
            const isPercentage = percentageFields.includes(currentVerticalLabelHPT);

            myChartHPT = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: sortedLabels,
                ...
                options: {
                    ...
                    plugins: {
                        tooltip: {
                            callbacks: {
                                label: (context) => isPercentage ? `${context.raw}%` : context.raw
                            }
                        },
                        legend: {
                            position: 'right'
                    ...
                    scales: {
                        x: {
                            title: {
                                display: true,
                                text: currentHorizontalLabelHPT
                            },
                            stacked: false
                        },
                        y: {
            ...
            // Update visibility
            hasDataHPT = true;
            document.getElementById('emptyStateHPT').classList.add('hidden');
            document.getElementById('pivotChartHPT').classList.remove('hidden');
            document.getElementById('pivotChartHPT').style.height = '400px';
        }

        function applyFiltersHPT() {
            const formData = new FormData(document.getElementById('filterFormHPT'));

            // Show overlay loading (transparent white background over chart)
            const overlay = document.getElementById('loadingOverlayHPT');
            overlay.classList.remove('hidden');
            overlay.classList.add('flex');

            fetch('{{ route('dashboard.hpt') }}', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    // Close dropdowns
                    document.getElementById('menu-dropdown-hpt')?.classList.add('hidden');
                    document.getElementById('age-menu-dropdown-hpt')?.classList.add('hidden');
                })
                .catch(err => {
        ...
        document.querySelectorAll('.comp-checkbox-hpt, .blok-checkbox-hpt, .plot-checkbox-hpt').forEach(cb => {
            cb.addEventListener('change', applyFiltersHPT);
        });

        ['searchCompHPT', 'searchBlokHPT', 'searchPlotHPT'].forEach(id => {
            document.getElementById(id).addEventListener('input', function(e) {
                const term = e.target.value.toLowerCase();
                const type = id.replace('searchHPT', '').replace('search', '').toLowerCase();
                document.querySelectorAll(`.${type}-item-hpt`).forEach(item => {
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ["Comp", "Blok", "Plot"].forEach(type => {
                const btn = document.getElementById(`dropdownButton${type}HPT`);
                const content = document.getElementById(`dropdownContent${type}HPT`);
                const selectAll = document.getElementById(`selectAll${type}HPT`);
                const checkboxes = document.querySelectorAll(`.${type.toLowerCase()}-checkbox-hpt`);
        ...
        function toggleAgeDropdownHPT() {
            document.getElementById('age-menu-dropdown-hpt').classList.toggle('hidden');
            document.getElementById('menu-dropdown-hpt').classList.add('hidden');
        }

        function toggleDropdownHPT() {
            document.getElementById('menu-dropdown-hpt').classList.toggle('hidden');
            document.getElementById('age-menu-dropdown-hpt').classList.add('hidden');
        }

        document.addEventListener('click', (e) => {
            const ageBtn = document.getElementById('age-menu-button-hpt');
            const ageDrop = document.getElementById('age-menu-dropdown-hpt');
            const timeBtn = document.getElementById('menu-button-hpt');
            const timeDrop = document.getElementById('menu-dropdown-hpt');
        ...
        const btnAvgHPT = document.getElementById("dropdownButtonAvgHPT");
        const menuAvgHPT = document.getElementById("dropdownContentAvgHPT");
        const labelAvgHPT = document.getElementById("dropdownLabelAvgHPT");
        const inputAvgHPT = document.getElementById("selectedAverageHPT");

        btnAvgHPT.addEventListener("click", () => menuAvgHPT.classList.toggle("hidden"));

        function selectAverageHPT(value, label) {
            inputAvgHPT.value = value;
            labelAvgHPT.textContent = label;
            menuAvgHPT.classList.add("hidden");
            applyFiltersHPT();
        }

        document.addEventListener("click", (e) => {
            if (!btnAvgHPT.contains(e.target) && !menuAvgHPT.contains(e.target)) menuAvgHPT.classList.add("hidden");
        });
