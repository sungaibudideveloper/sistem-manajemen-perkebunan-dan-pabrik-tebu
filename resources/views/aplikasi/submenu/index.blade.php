            ...
            <div class="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
                ...
                <div class="flex justify-start">
                    <button @click="resetForm()"
                        ...
                        <span class="hidden sm:inline">New Submenu</span>
            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-lg mx-auto max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 class="text-xl font-semibold text-gray-900" 
                        x-text="mode === 'create' ? 'Tambah Submenu' : 'Edit Submenu'"></h2>
                ...
                <!-- Modal Body -->
                <div class="p-6">
                    <form :action="mode === 'create' ? '{{ route('usermanagement.submenu.store') }}' : '{{ url('aplikasi/submenu') }}/' + form.submenuid" 
                          method="POST">
                        @csrf
                        ...
                        <!-- Menu Group Dropdown -->
                        <div class="mb-6">
                            <label for="menuid" class="block text-sm font-medium text-gray-700 mb-2">Menu Group</label>
                        ...
                        <!-- Submenu Name -->
                        <div class="mb-6">
                            <label for="submenuname" class="block text-sm font-medium text-gray-700 mb-2">Nama Submenu</label>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="slug" name="slug" x-model="form.slug" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="submenu-slug" />
                            <p class="mt-1 text-xs text-gray-500">URL-friendly version of the submenu name</p>
                        </div>

                        <!-- Parent ID -->
                        <div class="mb-6">
                            <label for="parentid" class="block text-sm font-medium text-gray-700 mb-2">Parent Code</label>
                            <input type="text" id="parentid" name="parentid" x-model="form.parentid"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="Optional parent identifier" />
                            <p class="mt-1 text-xs text-gray-500">Leave empty if this is a root submenu</p>
                        </div>
