            ...
            <div class="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
                ...
                <div class="flex justify-start">
                    <button @click="resetForm()"
                        ...
                        <span class="hidden sm:inline">New Data</span>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="py-3 px-2 sm:px-4 text-sm text-gray-700">
                                ...
                                <div class="text-xs text-gray-500 sm:hidden mt-1">
                                    ...
                                    <code class="bg-gray-100 px-1 py-0.5 rounded ml-1">{{ $d->slug }}</code>
                                </div>
                            </td>
        ...
        <div x-show="open" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" x-cloak
            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-auto max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 class="text-xl font-semibold text-gray-900" x-text="mode === 'create' ? 'Tambah Menu' : 'Edit Menu'"></h2>
                ...
                <div class="p-6">
                    <form :action="mode === 'create' ? '{{ route('masterdata.menu.store') }}' :  '{{ url('aplikasi/menu') }}/' + form.menuid" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500">URL-friendly version of the menu name</p>
                        </div>
