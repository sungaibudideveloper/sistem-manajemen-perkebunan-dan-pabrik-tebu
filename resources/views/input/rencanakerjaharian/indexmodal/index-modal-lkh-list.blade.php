                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="border border-gray-300 px-3 py-3">
                                        <div class="flex justify-center space-x-1">
                                            ...
                                            <!-- <div class="text-xs text-gray-400 mt-1" x-text="`can_submit: ${lkh.can_submit}, can_edit: ${lkh.can_edit}, status: ${lkh.status}, issubmit: ${lkh.issubmit}`"></div> -->
                                            ...
                                            <!-- Edit Button - Blue (same as main table) -->
