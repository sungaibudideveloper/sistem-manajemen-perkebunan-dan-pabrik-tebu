        ...
        <div class="mx-auto px-4 py-4">
            <div class="overflow-x-auto rounded-md border border-gray-300">
                <table class="min-w-full bg-white text-sm text-center">
                    <thead>
                        <tr>
                            <th class="py-2 px-4 border-b border-gray-300 bg-gray-100 text-gray-700 w-1">No. Voc</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="py-2 px-4 "><a href="#" class="text-blue-600 hover:underline">#VOC2904125</a></td>
                            <td class="py-2 px-4 ">RKH2904225</td>
                            <td class="py-2 px-4 ">29/04/2025</td>
                            <td class="py-2 px-4 ">DOLOMITE</td>
                            <td class="py-2 px-4 ">3.7 HA</td>
                            <td class="py-2 px-4 ">Yusril</td>
                            <td class="py-2 px-4 ">
                              <span class="inline-block px-2 py-1 text-xs font-semibold text-white bg-blue-600 rounded-full">
                                NEW
                              </span>
                        ...
                        <tr>
                            <td class="py-2 px-4 "><a href="#" class="text-blue-600 hover:underline">#VOC2904125</a></td>
                            <td class="py-2 px-4 ">RKH2904325</td>
                            <td class="py-2 px-4 ">29/04/2025</td>
                            <td class="py-2 px-4 ">DOLOMITE</td>
                            <td class="py-2 px-4 ">6 HA</td>
                            <td class="py-2 px-4 ">Hamzah</td>
                            <td class="py-2 px-4 ">
                              <span class="inline-block px-2 py-1 text-xs font-semibold text-white bg-blue-600 rounded-full">
                                NEW
                              </span>
                        ...
                        <tr>
                            <td class="py-2 px-4 "><a href="#" class="text-blue-600 hover:underline">#VOC2904125</a></td>
                            <td class="py-2 px-4 ">RKH2904425</td>
                            <td class="py-2 px-4 ">29/04/2025</td>
                            <td class="py-2 px-4 ">BASSAL DRESSING</td>
                            <td class="py-2 px-4 ">3 HA</td>
                            <td class="py-2 px-4 ">Maman</td>
                            <td class="py-2 px-4 ">
                        ...
                        <tr>
                            <td class="py-2 px-4 "><a href="#" class="text-blue-600 hover:underline">#VOC2904125</a></td>
                            <td class="py-2 px-4 ">RKH2904525</td>
                            <td class="py-2 px-4 ">29/04/2025</td>
                            <td class="py-2 px-4 ">BASSAL DRESSING</td>
                            <td class="py-2 px-4 ">3 HA</td>
                            <td class="py-2 px-4 ">Sukirno</td>
                            <td class="py-2 px-4 ">
                              <span class="inline-block px-2 py-1 text-xs font-semibold text-white bg-green-600 rounded-full">
                                  DISERAHKAN
                              </span>
