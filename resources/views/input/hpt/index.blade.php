<x-layout>
        ...
        <div class="flex lg:justify-between items-end mx-4 gap-2 justify-center flex-wrap">
            ...
            <div class="flex justify-center items-end gap-2 flex-wrap">
                ...
                <div class="flex gap-2 items-end flex-wrap justify-center">
                    <div id="ajax-data" data-url="{{ route('input.hpt.handle') }}">
                                    ...
                                    <div class="flex items-center justify-center">
                                        ...
                                        @if (hasPermission('Edit HPT'))
                                            @if ($item->status === 'Unposted')
                                                <a href="{{ route('input.hpt.edit', ['nosample' => $item->nosample, 'companycode' => $item->companycode, 'tanggalpengamatan' => $item->tanggalpengamatan]) }}"
                                        ...
                                        @if (hasPermission('Hapus HPT'))
                                            @if ($item->status === 'Unposted')
                                                <form
                                                    action="{{ route('input.hpt.destroy', ['nosample' => $item->nosample, 'companycode' => $item->companycode, 'tanggalpengamatan' => $item->tanggalpengamatan]) }}"
    ...
    <script>
        function showList(nosample, companycode, tanggalpengamatan) {
            ...
            const url =
                `{{ route('input.hpt.show', ['nosample' => '__nosample__', 'companycode' => '__companycode__', 'tanggalpengamatan' => '__tanggalpengamatan__']) }}`
