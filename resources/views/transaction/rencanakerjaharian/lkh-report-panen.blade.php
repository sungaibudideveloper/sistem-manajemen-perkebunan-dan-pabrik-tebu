...
<x-layout>
    ...
    <script>
        ...
        async function showSJModal(plot, subkontraktorId) {
            ...
            try {
                const response = await fetch(`{{ route('transaction.rencanakerjaharian.lkh-panen-report.get-sj') }}?plot=${plot}&subkontraktor_id=${subkontraktorId}&lkhno={{ $lkhData->lkhno }}`);
