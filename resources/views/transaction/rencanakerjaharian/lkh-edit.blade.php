<x-layout>
    ...
    <div x-data="{ showModal: false, modalType: '', modalMessage: '' }" 
        ...
        <div class="bg-white rounded-lg shadow-2xl w-full max-w-md">
            ...
            <div x-show="modalType === 'success'" class="p-6 text-center">
                ...
                <button @click="window.location.href = '{{ route('transaction.rencanakerjaharian.showLKH', $lkhData->lkhno) }}'"
    ...
    <form id="lkh-form" action="{{ route('transaction.rencanakerjaharian.updateLKH', $lkhData->lkhno) }}" method="POST">
        @csrf
        @method('PUT')
