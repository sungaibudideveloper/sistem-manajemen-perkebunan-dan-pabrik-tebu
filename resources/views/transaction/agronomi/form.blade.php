<x-layout>
    ...
    @error('duplicate')
        <div id="duplicateAlert"
            ...
            <button type="button" onclick="closeAlert('duplicateAlert')" class="ml-auto text-red-800 hover:text-red-900">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                        clip-rule="evenodd" />
                    ...
                    <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                        <tr>
                            ...
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">
                                Panjang GAP</th>
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">pH
                                Tanah</th>
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">Ktk
                                Gulma</th>
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">T.
                                Primer</th>
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">T.
                                Sekunder</th>
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">T.
                            ...
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">T.
                                Kuarter</th>
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">D.
                                Primer</th>
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">D.
                                Sekunder</th>
                            <th class="px-3 py-2.5 text-xs font-semibold text-gray-700 border-b border-gray-200">D.
