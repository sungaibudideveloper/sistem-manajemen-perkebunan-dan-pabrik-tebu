...
<div class="p-4 max-w-screen-xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row gap-3 mb-4">
        ...
        <div class="w-full md:w-1/3 p-2 bg-white shadow rounded">
            ...
            <div class="text-xs mb-1">{{ $details[0]->mandorname }}</div>
        ...
        <div class="w-full md:w-2/3 p-2 bg-white shadow rounded overflow-x-auto">
            <table class="w-full text-xs">
                ...
                <tbody class="text-gray-600">
                    @php $totalLuas = 0; dd($details); @endphp
                ...
                <table class="min-w-full text-xs">
                    ...
                    <tbody class="text-gray-600">
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-2 px-2 text-center">
                                <span class="luas">{{$luas}}</span>
                            </td>
                            <td class="py-2 px-2 text-center">
                                <span class="labelqty">{{ $matched->qty ?? '-' }}</span>
                            </td>
                            <td class="py-2 px-2 text-center">
                                {{ $matched->qtyretur }}
                            </td>
                            <td class="py-2 px-2 text-center">
                                ...
                                <a href="{{ route('transaction.gudang.retur', ['retur' => $matched->qtyretur, 'itemcode' => $d->itemcode, 'rkhno' => $details[0]->rkhno, 'herbisidagroupid' => $d->herbisidagroupid] ) }}" 
