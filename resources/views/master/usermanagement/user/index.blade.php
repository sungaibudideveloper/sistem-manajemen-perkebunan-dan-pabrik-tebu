        ...
        <div x-show="open" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4" x-cloak
            ...
            <div class="relative bg-white rounded-lg shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h3 class="text-xl font-semibold text-gray-900" x-text="mode === 'create' ? 'Tambah User' : 'Edit User'"></h3>
                ...
                <!-- Modal Body -->
                <div class="p-6">
                    <form :action="mode === 'create' ? '{{ route('usermanagement.user.store') }}' : editUrl" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="userid" x-model="form.userid"
                                ...
                                :readonly="mode === 'edit'"
                                :class="mode === 'edit' ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''"
                        ...
                        <!-- Company -->
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Primary Company <span class="text-red-500">*</span></label>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="password" x-model="form.password"
                                ...
                                minlength="6">
                            <template x-if="mode === 'edit'">
                                <div class="text-xs text-gray-500 mt-1">Kosongkan jika tidak ingin mengubah password</div>
                            </template>
                        </div>
