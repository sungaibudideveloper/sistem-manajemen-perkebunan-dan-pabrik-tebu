                    ...
                    <table class="min-w-full bg-white text-sm text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if (auth()->user() && collect(json_decode(auth()->user()->permissions ?? '[]'))->intersect(['Edit User', 'Hapus User', 'Hak Akses'])->isNotEmpty())
                                <td class="py-2 px-4 {{ $loop->last ? '' : 'border-b border-gray-300 w-40' }}">
                                    <div class="flex items-center justify-center">
                                        ...
                                        <a href="{{ route('masterdata.username.access', $item->userid) }}"
