<x-layout>
    ...
    <div class="mx-auto py-4 bg-white rounded-md shadow-md {{ $startDate && $endDate ? 'w-full' : 'w-fit' }}">
        ...
        @endif
        <div
            class="flex lg:justify-between mx-4 items-center gap-2 {{ $startDate && $endDate ? 'lg:justify-between justify-center' : 'justify-center' }} flex-wrap">
            @if ($startDate && $endDate)
                <div class="flex gap-2 text-sm">
                    ...
                    @if (hasPermission('Pivot HPT'))
                        <button
                            ...
                            onclick="window.location.href='{{ route('pivotTableHPT', ['start_date' => old('start_date', request()->start_date), 'end_date' => old('end_date', request()->end_date)]) }}'">
                            <svg class="w-5
                            h-5 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
                    ...
                    <table class="min-w-full bg-white text-sm text-center" id="tables">
                        <thead>
                            <tr>
                                ...
                                <th class="py-2 px-4 border-b border-gray-300 bg-gray-100 text-gray-700">SMUT
                                    Stadia 3</th>
                                <th class="py-2 px-4 border-b border-gray-300 bg-gray-100 text-gray-700">Jumlah Larva
                                    PPT</th>
                                <th class="py-2 px-4 border-b border-gray-300 bg-gray-100 text-gray-700">Jumlah Larva
                                    PBT</th>
                            </tr>
                        ...
                        <tbody>
                            @foreach ($hpt as $item)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b border-gray-300">{{ $item->jum_larva_ppt }}</td>
                                    <td class="py-2 px-4 border-b border-gray-300">{{ $item->jum_larva_pbt }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
