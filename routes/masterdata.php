...
Route::put('masterdata/upah/{jenisupah}/{harga}/{tanggalefektif}', [UpahController::class, 'update'])->middleware(['auth', 'permission:Edit Upah'])->name('masterdata.upah.update');
Route::delete('masterdata/upah/{jenisupah}/{harga}/{tanggalefektif}', [UpahController::class, 'destroy'])->middleware(['auth', 'permission:Hapus Upah'])->name('masterdata.upah.destroy');